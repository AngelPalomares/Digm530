...
public class ActivateTheDialog : MonoBehaviour
{
    ...
    void Update()
    {
        if (CanActivate && Input.GetButtonDown("Fire1") && !dialogueManager.instance.dialogbox.activeInHierarchy && !GameMenu.instance.TheMenu.activeInHierarchy && !BattleManager.instance.BattleActive|| CanActivate && Input.GetKeyDown(KeyCode.E) && !dialogueManager.instance.dialogbox.activeInHierarchy && !GameMenu.instance.TheMenu.activeInHierarchy)
        {
